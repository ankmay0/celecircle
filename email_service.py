...
FROM_EMAIL = os.getenv("FROM_EMAIL", "noreply@celelink.com")
...
def send_otp_email(email: str, otp: str) -> bool:
    ...
    """
    subject = "Your CeleLink Verification Code"
    body = f"""
    <html>
    <body style="font-family: Arial, sans-serif; padding: 20px;">
        <h2 style="color: #0077b5;">CeleLink Verification Code</h2>
        <p>Hello,</p>
        ...
        <p style="color: #666; font-size: 12px;">CeleLink - Entertainment Industry Marketplace</p>
    </body>
    </html>
    """
