...
This will create:
- Admin user: `admin@celecircle.com` / `admin123`
...
### As Admin:
1. Login with: `admin@celecircle.com` / `admin123`
...
The application uses SQLite by default (`celecircle.db`). For production, consider:
- PostgreSQL
- MySQL
...
### Database errors
- Delete `celecircle.db` and run `python seed_data.py` again
